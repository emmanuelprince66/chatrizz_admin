import type { UsersApiResponse } from "@/api/profile/fetch-user";
import { CustomTable } from "@/components/app/CustomTable";
import { useMemo } from "react";
import { useUsersColumns } from "./UsersColunm";

interface UsersTableProps {
  response: UsersApiResponse | undefined;
  loading: boolean;
...
const UsersTable = ({
  ...
  return (
    <CustomTable
      loading={loading}
      noDataText="No users found. Try adjusting your search criteria."
      columns={columns}
